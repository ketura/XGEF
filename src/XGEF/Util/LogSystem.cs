...
namespace XGEF
{
	...
	public class LogSystem : Utility, ILogger
	{
		...
		public bool LogActive { get => Log.LogActive; set => Log.LogActive = value; }
		public bool LogDebugInfo { get => Log.LogDebugInfo; set => Log.LogDebugInfo = value; }
		public LogLevel LogOutputLevel { get => Log.LogOutputLevel; set => Log.LogOutputLevel = value; }
		...
		{
			Log.Error(message, ex, memberName, sourceFilePath, sourceLineNumber);
		}
	}
}